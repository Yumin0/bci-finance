...
**申請單號與申請日期同步**（Riku）
分支：`feature/riku-app-number`
開始：2026-06-09
說明：現行單號前 8 碼取建立當天日期（如 20260608002），改為取表單右側「申請日期」欄位的值；序號（001/002/003）改為以同一申請日期底下已存在的申請數累計。例如選 2026/06/11，單號即為 20260611001，無論實際是哪天填單。
