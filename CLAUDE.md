...
src/
├── app/
│   ├── _components/       # 全局共享組件（SidebarLayout、ThemeProvider、HomeTabView、StatusBadge、WeekPicker、WeekFilterBar、ColumnPicker、useColumnVisibility、OrgScopeTree、SummaryCard、AllocationSummaryCard、ErrorDialog、ConfirmDialog、useConfirm、RecordDetailView、QuickReviewButtons 等）
